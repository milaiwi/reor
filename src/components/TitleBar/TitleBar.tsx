  ...
  return (
    <XStack backgroundColor="$gray3" className="electron-drag flex justify-between bg-[#303030]">
      ...
      >
        ...
        {showChatbot ? (
          <MessageSquareOff
            className="electron-no-drag mx-1 mt-[0.2rem] -scale-x-100 cursor-pointer p-[2px] text-gray-100"
            size={19}
          ...
          <MessageSquareMore
            className="electron-no-drag mt-[0.2rem mx-1 -scale-x-100 cursor-pointer p-[2px] text-gray-100"
            size={22}
            title="Show Chatbot"
            onClick={() => setShowChatbot((show) => !show)}
          />
