...
export const Field = ({ id, label, children }: PropsWithChildren<{ label: string; id: string }>) => {
  return (
    <YStack gap="$1" f={1}>
...
export const SwitchField = ({ label, id, ...props }: SwitchProps & { label: string; id: string }) => {
  return (
